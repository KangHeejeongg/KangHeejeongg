...
- 🎓 서경대학교 컴퓨터공학과 졸업 (학점 4.15 / 2025.08)
- 🏫 삼성 청년 SW·AI 아카데미(SSAFY) 14기 수료
- 💼 풀스택 + AI 엔지니어링 + DevOps/Infra 경험 보유
- 🌱 기술로 문제를 해결하고, 협업으로 더 멀리 가는 개발자
...
| 프로젝트 | 설명 | 역할 | 기간 |
|---|---|---|---|
| **오손도손** | 온디바이스 End-to-End AI 기반 농인-청인 실시간 양방향 수어 소통 서비스 | 인프라 전담 · AI 추론 서버 | 2025.04 ~ 2025.06 |
| **CARe** | 블록체인 기반 글로벌 렌터카 중개 플랫폼 (AI 흠집 탐지·신원 인증·자동 정산) | AI 차량 스캔 · 업체 웹앱 · 예약 백엔드 | 2026.02 ~ 2026.03 |
| **CarryPorter** | 교통약자를 위한 공항 내 호출형 짐 운반 자율주행 로봇 | 백엔드(인증·SSE·MQTT) · 3D 관리자 대시보드 | 2026.01 ~ 2026.02 |

<br/>

## 💼 Experience

- **팜피 주식회사** 개발팀 인턴 (2024.09 ~ 2024.12)<br/>
  웹기반 XR 콘텐츠 저작도구 및 플랫폼 시스템 고도화 (Vue.js · Spring Boot)
...
**수상**
- 🥈 우수상 (삼성전자) · 2026.06 · 자율 프로젝트 — 온디바이스 AI 실시간 양방향 소통 서비스
- 🥈 우수상 (삼성전자) · 2026.03 · 특화 프로젝트 — 블록체인 기반 렌터카 중개 플랫폼
- 🥈 우수상 (삼성전자) · 2026.02 · 공통 프로젝트 — 교통약자 짐 운반 주행 로봇
- 🎖️ 입선 (한국정보산업연합회) · 2023.12 · 빅데이터 기반 서버 이상탐지
- 🎖️ 입선 (한국정보산업연합회) · 2022.12 · 마스크 착용 & 추천 지능형 앱
...
<div align="center">
  <a href="mailto:he5298@naver.com">
    <img src="https://img.shields.io/badge/he5298@naver.com-03C75A?style=for-the-badge&logo=naver&logoColor=white">
  </a>
</div>
